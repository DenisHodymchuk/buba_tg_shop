              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20, borderBottom: '1px solid rgba(255,255,255,0.06)', paddingBottom: 16 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{
                    ...
                    background: 'linear-gradient(135deg, rgba(124,58,237,0.3), rgba(45,212,191,0.3))',
                    border: '1px solid rgba(124,58,237,0.4)',
                  ...
                  <div>
                    <h2 style={{ fontSize: 20, fontWeight: 900, margin: 0, color: '#fff' }}>
                      {editingSale ? 'Редагувати запис про продаж' : 'Новий запис про продаж'}
                    </h2>
                    <p style={{ margin: 0, fontSize: 12, color: 'var(--text-muted)' }}>
                      Вкажіть дані клієнта, склад замовлення та статус
                    </p>
                  </div>
                </div>
